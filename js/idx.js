...
var earth;
        ...
        loader2.load('assets/md/e2.js', function (geometry, materials) {
            var material = materials[0]; 
          
             earth = new THREE.MorphAnimMesh(geometry, new THREE.MeshFaceMaterial(materials)); 
       
           
           
            earth.scale.x = earth.scale.y = earth.scale.z =3.15;
            scene.add(earth);
